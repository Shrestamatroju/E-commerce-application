...
app.get('/newcollections',async(req,res)=>{
    let products=await Product.find({}); ///all the products will be savd in this array
    ...
    if(!token){
        ...
        try{
          ...
          next();
            ...
            express.response.status(401).send({errors:"please authenticate using  valid token"})
        }
    }
}
...
//     //chatpgt if statement
if (!userData.cartData[req.body.itemId]) {
    userData.cartData[req.body.itemId] = 0;
}
// if (!userData.cartData || !userData.cartData.hasOwnProperty(req.body.itemId)) {
//     userData.cartData[req.body.itemId] = 0;
// }
